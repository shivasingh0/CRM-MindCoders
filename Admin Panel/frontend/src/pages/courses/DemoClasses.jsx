  ...
  return (
    <>
      <div className="container-fluid">
                        ...
                        <div className="modal-dialog" role="document">
                          <div className="modal-content">
                            ...
                            <div className="modal-body">
                              <h4>
                                Are you sure to delete this MPPSC MAINS (Warrior
                                Batch) Batch - Rs.50000?
                              </h4>
                              <div className="mt-4">
                            ...
                            <div className="modal-body">
                              ...
                              <div className="col-md-12 mb-2">
                                <label className="mb-2">
                                  <strong>
                                    Mention the Course You Wish to Join*
                                  </strong>
                                </label>
                                <select
                              ...
                              <div className="col-md-12">
                                ...
                                >
                                  <i className="bi-input-cursor-text" /> update
                                  demo class
                                </button>
                              </div>
                            </div>
       ...
       <AddDemoClass show={addDemoModelShow} onHide={()=>setAddDemoModelShow(false)} />  
